...
from utils import MySCLImageDataset, SpatiotemporalTransform
for _ in range(2):
    try:
...
#     )
    ...
    torch.save(simclr_encoder.state_dict(), '../../model_checkpoint/encoder_params_resnet50_spatiotemporal_with_aug_Delhi_SimCLR.pkl')
